...
public class QuaEqua {
    ...
    void Discriminant() {
        ...
        if (a == 0) {
            ...
            double x;
            x = -c / b;
            System.out.println("Неизвестная х равна " + x + ", а уравнение имеет вид "+ b + "x" + " + " + c + " = 0");
        }
            ...
            System.out.println("Корни уравнения: x1 = (-b - sqr(D)) / 2a = " + x1 + ", x2 = (-b + sqr(D)) / 2a = " + x2 + " при a = " + a + ", b = " + b + ", c = " + c + ".");
            System.out.println();
        } else if (D == 0) {
            double x;
            x = -b / (2 * a);
            System.out.println("Уравнение имеет единственный корень: x = -b / (2a) = " + x + " при a = " + a + ", b = " + b + ", c = " + c + ".");
            System.out.println();
        } else
